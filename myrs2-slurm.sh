...
os.chdir('session01/array02'); DPT.objects.processDirs(level='channel', cmd='import PyHipp as pyh; from PyHipp import mountain_batch; mountain_batch.mountain_batch(); from PyHipp import export_mountain_cells; export_mountain_cells.export_mountain_cells();');
...
aws sns publish --topic-arn arn:aws:sns:ap-southeast-1:961244032502:awsnotify --message "RS2JobDone"
